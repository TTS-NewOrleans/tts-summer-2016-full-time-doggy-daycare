...
class DogsControllerTest < ActionController::TestCase
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post :create, dog: { breed_id: @dog.breed_id, dob: @dog.dob, in_daycare: @dog.in_daycare, medical_info: @dog.medical_info, name: @dog.name, vet_id: @dog.vet_id }
    end
  ...
  test "should update dog" do
    patch :update, id: @dog, dog: { breed_id: @dog.breed_id, dob: @dog.dob, in_daycare: @dog.in_daycare, medical_info: @dog.medical_info, name: @dog.name, vet_id: @dog.vet_id }
    assert_redirected_to dog_path(assigns(:dog))
  end
